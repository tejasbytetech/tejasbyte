          ...
          <div className="contact-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1.9fr", gap: 32, alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <div style={{ background: "#fff", border: "1.5px solid #E2E4EA", borderRadius: 12, padding: "18px 20px", display: "flex", alignItems: "flex-start", gap: 14, transition: "border-color .2s" }}
                ...
                <div style={{ width: 42, height: 42, borderRadius: 10, flexShrink: 0, background: "#fff", border: "1.5px solid #E2E4EA", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.1rem" }}>📍</div>
                <div>
                  <p style={{ fontSize: ".62rem", fontWeight: 700, letterSpacing: ".1em", textTransform: "uppercase", color: "#9CA3AF", marginBottom: 4 }}>Our Offices</p>
              ...
              <div style={{ background: "#fff", border: "1.5px solid #E2E4EA", borderRadius: 12, padding: "18px 20px", display: "flex", alignItems: "flex-start", gap: 14, transition: "border-color .2s" }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(91,48,232,0.35)"; }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor = "#E2E4EA"; }}>
                <div style={{ width: 42, height: 42, borderRadius: 10, flexShrink: 0, background: "#fff", border: "1.5px solid #E2E4EA", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.1rem" }}>✉️</div>
                <div>
              ...
              <div style={{ background: "#fff", border: "1.5px solid #E2E4EA", borderRadius: 12, padding: "18px 20px", display: "flex", alignItems: "flex-start", gap: 14, transition: "border-color .2s" }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(91,48,232,0.35)"; }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor = "#E2E4EA"; }}>
                <div style={{ width: 42, height: 42, borderRadius: 10, flexShrink: 0, background: "#fff", border: "1.5px solid #E2E4EA", display: "flex", alignItems: "center", justifyContent: "center" }}>
